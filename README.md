...
* **шрифт:** - google fonts
* **фон:* - замыленая, сжатая картинка с блюром и окантовкой затенением, с рандомным патерном звезд, ребутаются после ф5
...
| <span style="color:#050505">●</span> **Black** | `#050505` | Основной «Y2K» фон |
